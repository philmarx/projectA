...
import com.hzease.tomeet.utils.AMapUtil;
...
public class DrivingRouteOverlay extends RouteOverlay{
    ...
    public DrivingRouteOverlay(Context context, AMap amap, DrivePath path,
                               LatLonPoint start, LatLonPoint end, List<LatLonPoint> throughPointList, double lat, double lng, String roomPlace, Activity activity) {
    	super(context, lat, lng,roomPlace,activity);
    	mContext = context; 
        mAMap = amap; 
        this.drivePath = path;
