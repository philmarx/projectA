...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = PTApplication.getInstance().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = PTApplication.getInstance().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
